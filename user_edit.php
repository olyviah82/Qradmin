                                    ...
                                    <div class="card-body">
                                        <form action="code.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="au-input au-input--full" type="text" name="dname"
                                                    value="<?= $user->displayName; ?>" placeholder="Username">
                                            </div>

                                            <div class="form-group">
                                                <label>Phonenumber</label>
                                                <input class="au-input au-input--full" type="text"
                                                    value="<?= $user->phoneNumber; ?>" name="phone" placeholder="Phone">
                                            </div>

                                            <button class="au-btn au-btn--block au-btn--green m-b-20" name="user_edit"
                        ...
                        <div class="card-body">
                            <form action="code.php" method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <select name="select_enable_disable" id="" class="form-control" required>
                                        <option value="">Select</option>
                                        <option value="enable">Enabled</option>
                                        <option value="disable">Disabled</option>
                                    </select>
                                    <button class="au-btn--submit" type="submit"
                                        name="enable_disable_ac">Submit</button>
